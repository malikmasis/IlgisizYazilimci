...
namespace WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        List<Category> categories = new List<Category>
            {                                                     
                new Category{ Id = 1, Name = "Java"},
                new Category{ Id = 2, Name = "C#"},
                new Category{ Id = 3, Name = "Pyhton"},
                new Category{ Id = 4, Name = "ASP .net MVC"},
                new Category{ Id = 5, Name = "Spring Mvc"},
                new Category{ Id = 6, Name = "Database"}
            };
