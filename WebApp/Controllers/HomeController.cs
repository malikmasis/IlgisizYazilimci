...
namespace WebApp.Controllers
{
    public class HomeController : Controller
    {
        public static List<Blog> kitaplar = new List<Blog>
        {
            ...
            new Blog{ CreatedDate = DateTime.Today, CreteUser = new User(){ Id =1,Name ="Malik"}, Id = 1, Title = "Asp ile geliştirme", Content = "Asp.Net MVC 5 dsad33Tincidunt integer eu augue augue nunc <hr/><br/> elit dolor, luctus placerat scelerisque euismod, iaculis eu lacus nunc mi elit, vehicula ut laoreet ac, aliquam sit amet justo nunc tempor, metus vel.33333333333", ViewCount= 34},
